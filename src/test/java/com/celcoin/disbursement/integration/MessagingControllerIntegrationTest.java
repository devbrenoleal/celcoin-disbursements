...
public class MessagingControllerIntegrationTest extends BaseIntegrationTest {
    ...
    void initializeKafkaConsumer() {
        ...
        // Usamos um group.id único para cada suíte, mas mantemos o 'earliest'
        Map<String, Object> consumerProps = KafkaTestUtils.consumerProps(
                kafkaContainer.getBootstrapServers(),
                "messaging-integration-test-group",
                "true" // auto-commit
        );
        // Deixamos o padrão de KafkaTestUtils, que é 'earliest'
    ...
    void postMessage_withInvalidJson_shouldReturnBadRequest() throws Exception {
        ...
        // Assert (Kafka)
        // Damos um pequeno tempo para garantir que a thread do consumidor não pegue nada por engano
